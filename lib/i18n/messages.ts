...
const messages = {
  ...
  en: {
    siteMeta: {
      title: "evo-lee's blog · deliberate evolution",
      description: 'In the AI age, learning and evolving remain personal choices.',
    },
    ...
    home: {
      ...
      ticker: [
        ...
        'Writing in public, steady cadence',
        'Latest work: EvoNote in progress',
        'Workflow: daily Claude Code',
      ],
      articlesTitle: 'Posts',
